...
export default async function handler(req: Request) {
  ...
  try {
    ...
    // See netlify/functions/chat.mts: documents whose extraction failed still
    // hold the raw PDF container as their text, which reads as confident
    // nonsense to the model.
