    ...
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '60px 20px', background: 'var(--surface)', minHeight: '100dvh' }}>
      <div style={{ background: 'white', padding: '40px' }}>
        <header style={{ marginBottom: '40px', borderBottom: '2px solid var(--accent-ink)', paddingBottom: '20px' }}>
          <h1 style={{ fontSize: '2.5rem', color: 'var(--ink)', marginBottom: '10px' }}>Privacy Policy</h1>
          <p style={{ fontSize: '0.95rem', color: 'var(--muted)' }}>Last updated: August 12, 2026</p>
        </header>

        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>Introduction</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>Signal87 ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform, including our website and mobile applications (the "Service").</p>
          <p style={{ color: 'var(--ink-2)' }}>Please read this Privacy Policy carefully. If you do not agree with our policies and practices, please do not use our Service.</p>
        </section>

        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>1. Information We Collect</h2>

          <h3 style={{ fontSize: '1.1rem', color: 'var(--ink)', marginTop: '25px', marginBottom: '10px' }}>1.1 Information You Provide Directly</h3>
          ...
          <h3 style={{ fontSize: '1.1rem', color: 'var(--ink)', marginTop: '25px', marginBottom: '10px' }}>1.2 Information Collected Automatically</h3>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
          ...
          <h3 style={{ fontSize: '1.1rem', color: 'var(--ink)', marginTop: '25px', marginBottom: '10px' }}>1.3 Information from Third Parties</h3>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
        ...
        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>2. How We Use Your Information</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>We use the collected information for:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
        ...
        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>3. AI Processing and Analysis</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>Signal87 uses advanced AI models (including Google Gemini and OpenAI GPT) to analyze your documents and provide insights. When you submit documents for analysis:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
        ...
        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>4. Data Storage and Security</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>Your data is stored securely using:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
          ...
          <p style={{ color: 'var(--ink-2)' }}>While we implement comprehensive security measures, no system is 100% secure. We cannot guarantee absolute security of your information.</p>
        </section>

        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>5. Sharing Your Information</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>We do NOT sell, trade, or rent your personal information. We may share information:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
        ...
        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>6. Your Rights and Choices</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>Depending on your location, you may have the right to:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
          ...
          <p style={{ color: 'var(--ink-2)' }}>To exercise these rights, contact us at the address below.</p>
        </section>

        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>7. Contact Us</h2>
          <div style={{ background: 'var(--surface)', border: '1px solid var(--rule)', padding: '20px', borderRadius: '8px', marginTop: '20px' }}>
            ...
            <p style={{ marginBottom: '8px', color: 'var(--ink-2)' }}>Email: <a href="mailto:privacy@signal87.ai" style={{ color: 'var(--accent-ink)', textDecoration: 'none' }}>privacy@signal87.ai</a></p>
        ...
        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>8. California Privacy Rights (CCPA)</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>If you are a California resident, you have specific rights under the California Consumer Privacy Act:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
          ...
          <p style={{ color: 'var(--ink-2)' }}>Contact us to exercise these rights.</p>
        </section>

        <section style={{ marginBottom: '30px' }}>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--ink)', marginBottom: '15px' }}>9. EU General Data Protection Regulation (GDPR)</h2>
          <p style={{ marginBottom: '15px', color: 'var(--ink-2)' }}>If you are located in the EU, UK, or EEA, you have rights under GDPR including the right to access, rectify, erase, and port your data. We process your information based on:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '15px', color: 'var(--ink-2)' }}>
          ...
          <p style={{ color: 'var(--ink-2)' }}>Contact us for any GDPR-related requests.</p>
        </section>
      </div>
    </div>
  );
