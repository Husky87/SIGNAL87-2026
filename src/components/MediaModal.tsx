      ...
      <div className="bg-[var(--surface)] border border-[var(--rule)] rounded-3xl max-w-3xl w-full p-6 sm:p-8 space-y-6 relative my-8 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center gap-3 border-b border-[var(--rule-2)] pb-5">
          <div className="p-2.5 bg-[var(--accent-soft)] rounded-2xl flex items-center justify-center">
            <Tv size={24} className="text-[var(--accent-ink)]" />
          </div>
          <div>
        ...
        {/* Fast Bio Overview */}
        <div className="bg-[var(--surface-2)] p-5 rounded-2xl border border-[var(--rule)]/80 space-y-3">
          <div className="flex items-center gap-2">
            <Signal87Logo size={24} />
            <span className="font-extrabold text-[var(--ink)] text-sm">About Signal87 AI Inc.</span>
          </div>
          <p className="text-xs sm:text-sm text-[var(--ink-2)] leading-relaxed font-normal">
            Signal87 AI is the enterprise document memory and legal AI research platform engineered for real-time verification and zero-hallucination citation synthesis. Founded by <strong className="text-[var(--ink)]">Michael Benezra</strong> (CEO & Co-Founder) and <strong className="text-[var(--ink)]">Michael Chavira</strong> (Co-Founder & Chief Systems Architect), Signal87 empowers legal, corporate governance, and legislative research teams across North America.
          </p>
        </div>

        {/* Media Contact & Brand Assets */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-4 bg-[var(--surface)] border border-[var(--rule)] rounded-2xl space-y-2">
            <h3 className="font-bold text-[var(--ink)] text-xs flex items-center gap-2 uppercase tracking-wider">
              <Mail size={15} className="text-[var(--accent)]" /> Press Contact
            </h3>
            ...
            <a
              ...
              className="text-xs font-bold text-[var(--accent)] hover:underline block pt-1"
            >
              press@signal87.ai
            </a>
          </div>
          ...
          <div className="p-4 bg-[var(--surface)] border border-[var(--rule)] rounded-2xl space-y-2">
            <h3 className="font-bold text-[var(--ink)] text-xs flex items-center gap-2 uppercase tracking-wider">
              <Download size={15} className="text-[var(--ok)]" /> Official Brand Kit
            </h3>
            <p className="text-xs text-[var(--ink-2)]">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[var(--surface-2)] hover:bg-[var(--rule)] text-[var(--ink)] text-xs font-bold rounded-xl transition-colors cursor-pointer inline-flex items-center gap-1 mt-1"
            >
        ...
        <div className="space-y-3">
          <h3 className="font-bold text-[var(--ink)] text-xs uppercase tracking-wider">
            Recent Press Releases & News
          </h3>

          <div className="space-y-2.5">
            <div className="p-3.5 bg-[var(--surface-2)] rounded-2xl border border-[var(--rule)]/80 flex items-start justify-between gap-3 text-xs">
              <div className="space-y-1">
                <span className="text-[10px] font-mono font-bold text-[var(--muted)] block">July 2026 • Press Release</span>
                ...
                <p className="text-[var(--muted)] text-[11px] line-clamp-1">
            ...
            <div className="p-3.5 bg-[var(--surface-2)] rounded-2xl border border-[var(--rule)]/80 flex items-start justify-between gap-3 text-xs">
              <div className="space-y-1">
                <span className="text-[10px] font-mono font-bold text-[var(--muted)] block">April 2026 • LegalTech Today</span>
                <span className="font-bold text-[var(--ink)] block">
